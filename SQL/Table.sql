...
ALTER TABLE task ADD CONSTRAINT auth_fk5 FOREIGN KEY (steps_id) REFERENCES steps(step_id);
...
ALTER TABLE users ADD CONSTRAINT auth_fk9 FOREIGN KEY (posts_id) REFERENCES post(id);
ALTER TABLE users ADD CONSTRAINT auth_fk10 FOREIGN KEY (tasks_id) REFERENCES task(id);